...
// JS has access to top level awaits!
const response = await fetch('https://localhost:3000/resources');
const data =awaits response.json();
...
Here are polished, concise answers you can drop straight into your reflection. They sound thoughtful, technical, and aligned with the work you just completed.

---

## **Encapsulation & Validation**  
I enforced validation inside the constructor and the behavior‑centric methods (`Rename` and `ChangePriority`). This ensures that invalid state can never enter the object, no matter how or when the properties are changed. Keeping validation at the boundaries of the class protects the internal state and maintains strong encapsulation.

---

## **Testing Insight**  
The theory tests for invalid titles and invalid priorities were the most revealing because they immediately exposed whether my validation logic was correct. They confirmed that the class consistently rejected bad input and helped verify that exceptions were thrown exactly as expected. These tests gave the clearest signal that the implementation behaved reliably under different scenarios.

---

If you want, I can help you refine these even further to match your instructor’s tone or your writing style.
